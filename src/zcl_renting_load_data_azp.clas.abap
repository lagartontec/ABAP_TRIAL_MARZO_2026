CLASS zcl_renting_load_data_azp DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_data_azp IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA: lt_brands    TYPE TABLE OF zrent_brands_azp,
          lt_cars      TYPE TABLE OF zrent_cars_azp,
          lt_customers TYPE TABLE OF zrent_custom_azp.
...
** BRANDS **
    ...
    ( marca = 'BENTLEY' url =
    'https://www.autobild.es/sites/autobild.es/public/styles/main_element/public/dc/fotos/Bentley-Continental_GT-2018-C01.jpg?itok=_kP_edH4' )
    ...
    'https://api.ferrarinetwork.ferrari.com/v2/network-content/medias/resize/5dd552852cdb32285a785d2e-line-up-ferrari-sf90-stradale?apikey=9QscUiwr5n0NhOuQb463QEKghPrVlpaF&width=800&height=600' )
    ( marca = 'FORD' url =
    'https://www.elsoldemexico.com.mx/deportes/automotriz/1i0d6x-02_2019.png/ALTERNATES/LANDSCAPE_400/02_2019.png' )

    ( marca = 'HONDA' url =
    'https://cdn.autobild.es/sites/navi.axelspringer.es/public/styles/480/public/media/image/2017/06/643677-honda-civic-type-r-2017.jpg?itok=pmaP2b_K' )
    ( marca = 'JEEP' url =
    'https://s.aolcdn.com/commerce/autodata/images/USC80JES162A021001.jpg' )
    ( marca = 'KIA' url =
    'https://www.kia.com/content/dam/kwcms/mx/es/images/vehicles/thumnails_2025/menu_showrooms/Perfil-Home-Stinger.png' )
    ...
    ( marca = 'VW' url =
    'https://www.vwimg.com/iris/iris?bkgnd=transparent&fabric=BC&paint=0Q0Q&pov=E06,CGN&quality=100&vehicle=2025_BU32MS_2019_10_27&Resp=png&width=510&crop=20,90,450,232' )
    ( marca = 'BMW' url =

    'https://www.bmw.com.mx/content/dam/bmw/common/all-models/3-series/sedan/2018/navigation/bmw-3-series-modellfinder.png' ) ).

    DELETE FROM zrent_brands_azp.
    INSERT zrent_brands_azp FROM TABLE @lt_brands.
    SELECT * FROM zrent_brands_azp INTO TABLE
    @lt_brands.
    out->write( sy-dbcnt ).
...
fecha_fabr = '20250304' puertas = '3' precio = '140'
moneda = 'USD' alquilado = 'X' alq_desde =
'20260701' alq_hasta = '20260708' )
...
fecha_fabr = '20250924' puertas = '5' precio = '160'
moneda = 'USD' alquilado = 'X' alq_desde =
'20250601' alq_hasta = '20251001' )
( matricula = '2837KFF' marca = 'MERCEDES'
modelo = 'CLASE B' color = 'NEGRO' motor = '2.0'
potencia = '200' und_potencia = 'CV'
combustible = 'GASOLINA' consumo = '7.00'
fecha_fabr = '20250726' puertas = '5' precio = '160'
moneda = 'USD' alquilado = 'X' alq_desde =
'20250301' alq_hasta = '20260301' )
...
fecha_fabr = '20250614' puertas = '5' precio = '180'
moneda = 'USD' alquilado = 'X' alq_desde =
'20261201' alq_hasta = '20261206' )
...
fecha_fabr = '20260716' puertas = '5' precio = '180'
moneda = 'USD' alquilado = 'X' alq_desde =
'20261201' alq_hasta = '20261206' )
...
fecha_fabr = '20250812' puertas = '3' precio = '150'
moneda = 'USD' alquilado = 'X' alq_desde =
'20261106' alq_hasta = '20261206' )
).

    DELETE FROM zrent_cars_azp.
    INSERT zrent_cars_azp FROM TABLE @lt_cars.
    SELECT * FROM zrent_cars_azp INTO TABLE @lt_cars.
    out->write( sy-dbcnt ).
...
** CUSTOMERS**
    ...
    DELETE FROM zrent_custom_azp.
    INSERT zrent_custom_azp FROM TABLE @lt_customers.
    SELECT * FROM zrent_custom_azp INTO TABLE
    @lt_customers.
    out->write( sy-dbcnt ).
